...
class RendererComponent : public Component {
 public:
  ...
  //! derived from component - loops through the currently selected animation
  //! frames
  void update();
  ...
  //! loads an animation from the given path and stores the data of the starting
  //! frame, num frames, and total frames
  void loadAnimation(string path, int startingFrame, int numFrames,
 ...
 private:
  ...
  std::unordered_map<string, std::tuple<int, int>>
      animationFrames;  // starting ->< Number of frames tuple
